      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.card}>
            ...
            <Text style={styles.instructionTitle}>To claim your funds:</Text>
            <Text style={styles.instruction}>
              Sign in with your Coinbase Smart Wallet to securely receive your {transfer.token}.
            </Text>
      ...
      <View style={styles.container}>
        <View style={styles.errorCard}>
          ...
          <Text style={styles.errorMessage}>
            This transfer was sent to <Text style={styles.bold}>{transfer.recipientEmail}</Text> but
            you're signed in as <Text style={styles.bold}>{profile?.email}</Text>.
          </Text>
          <Text style={styles.errorMessage}>
            Please sign in with the correct email address to claim this transfer.
          </Text>
          <PrimaryButton
            title="Go to Home"
            onPress={() => navigation.navigate("Home")}
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.card}>
          <Text style={styles.icon}>🎉</Text>
          <Text style={styles.title}>Claim Your Transfer</Text>
          <Text style={styles.amount}>
            {transfer.amount} {transfer.token}
          </Text>
          <Text style={styles.fromText}>
          ...
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>
              Your {transfer.token} will be sent to your MetaSend wallet instantly.
            </Text>
          </View>
        </View>
      </ScrollView>
