...
const NETWORK_CHAIN_MAP: Record<EscrowNetwork, typeof base | typeof baseSepolia> = {
  base,
...
class SharedEscrowDriver {
  ...
  constructor() {
    this.network = (process.env.ESCROW_NETWORK as EscrowNetwork) || "base-sepolia";
    ...
    this.tokenAddress = (process.env.ESCROW_TOKEN_ADDRESS as `0x${string}`) || USDC_TOKEN_ADDRESS;
