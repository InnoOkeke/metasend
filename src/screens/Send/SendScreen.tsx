  ...
  const mutation = useMutation({
    ...
    onSuccess: async (payload) => {
      ...
      if (payload.status === "pending_recipient_signup") {
        ...
        showToast(`Successfully sent ${form.amount} USDC to ${form.email}`, "success");
      }
    },
    onError: (error) => {
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.confirmationDetails}>
              ...
              <View style={styles.confirmationRow}>
                ...
                <Text style={styles.confirmationValue}>Base Sepolia</Text>
              </View>

              <View style={styles.confirmationRow}>
                <Text style={styles.confirmationLabel}>Gas Fee</Text>
                <Text style={styles.confirmationFree}>Free (Coinbase Paymaster)</Text>
              </View>
            </View>
